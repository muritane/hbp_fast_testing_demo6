...
@nrp.MapRobotSubscriber('camera',         Topic('/camera_0/image_raw',     Image))
@nrp.MapRobotPublisher( 'plot_topic',     Topic('/pred_plot_0',            Image))
@nrp.MapRobotPublisher( 'latent_topic',   Topic('/latent_0',   Float32MultiArray))
@nrp.MapRobotPublisher( 'pred_pos_topic', Topic('/pred_pos_0', Float32MultiArray))
...
@nrp.Robot2Neuron()
def img_to_pred_0(t, camera, plot_topic, latent_topic, pred_pos_topic, pred_msg,
