...
@nrp.MapRobotSubscriber('camera',         Topic('/camera_2/image_raw',     Image))
@nrp.MapRobotPublisher( 'plot_topic',     Topic('/pred_plot_2',            Image))
@nrp.MapRobotPublisher( 'latent_topic',   Topic('/latent_2',   Float32MultiArray))
@nrp.MapRobotPublisher( 'pred_pos_topic', Topic('/pred_pos_2', Float32MultiArray))
...
@nrp.Robot2Neuron()
def img_to_pred_2(t, camera, plot_topic, latent_topic, pred_pos_topic, pred_msg,
