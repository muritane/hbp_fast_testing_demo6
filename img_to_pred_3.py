...
@nrp.MapRobotSubscriber('camera',         Topic('/camera_3/image_raw',     Image))
@nrp.MapRobotPublisher( 'plot_topic',     Topic('/pred_plot_3',            Image))
@nrp.MapRobotPublisher( 'latent_topic',   Topic('/latent_3',   Float32MultiArray))
@nrp.MapRobotPublisher( 'pred_pos_topic', Topic('/pred_pos_3', Float32MultiArray))
